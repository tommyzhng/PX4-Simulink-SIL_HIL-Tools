 /*  File    : GPSPackagingSFunc
 *   Purpose : Package inputs from simulated GPS measurements into a mavlink message to merge with other messages to the PX4 SITL sim
...
#define S_FUNCTION_NAME  GPSPackagingSFunc
